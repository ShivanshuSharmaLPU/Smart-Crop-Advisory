...
router.post('/crop', auth, async (req, res) => {
    try {
        const inputs = req.body; // Expects N, P, K, temperature, etc.
...
router.post('/fertilizer', auth, async (req, res) => {
    try {
        const inputs = req.body; // Expects N, P, K, etc.
...
router.post('/disease', auth, async (req, res) => {
    try {
        const inputs = req.body;
        // In real app, handle file upload here and send file/bytes to ML
